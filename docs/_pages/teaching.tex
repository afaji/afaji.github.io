...
I also ensure that the teaching is interactive and engaging. I strive to make the classroom less intimidating by incorporating humor and keeping the mood light. I design assessments that are fun and interactive. For example, in my recent graduate courses, I replaced standard final presentations with a poster session, mimicking a real academic conference where students actively discussed their work. For the upcoming undergraduate Algorithms course, I am designing a competitive multiplayer game framework where students will implement algorithms to control agents that fight against one another.
